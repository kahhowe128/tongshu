...
const ACADEMY = [
  {
    ...
    sections: [
      { h: ['立竿见影：最古老的天文台', 'The gnomon: the oldest observatory'], figure: 'sky_gnomon',
        body: ['在没有钟表与卫星的年代，古人观天的第一件工具简单得令人意外——一根直立的杆子，叫「圭表」。正午量它投下的影子：影子最长的那天，太阳最偏南，是为冬至；影子最短的那天则是夏至。一年里影子的长短轮回，便把四季牢牢钉住。\n\n河南登封的「观星台」（元代郭守敬曾用）至今仍在，是这套「立竿见影」之法的实物见证。早在汉代《淮南子·天文训》，二十四节气的名称与次序便已完整记载——我们今天用的，仍是两千年前那一套。',
          'In an age without clocks or satellites, the first tool for reading the sky was startlingly plain — an upright pole called a 圭表 (gnomon). At noon you measured the shadow it cast: the day the shadow was longest the sun sat furthest south — the winter solstice; the day it was shortest, the summer solstice. The yearly cycle of that shadow pinned the four seasons in place.\n\nThe Dengfeng observatory in Henan (used by the Yuan-dynasty astronomer Guo Shoujing) still stands as physical witness to this "set a pole, watch the shadow" method. As early as the Han-era Huainanzi the names and order of the 24 solar terms were already recorded in full — what we use today is the very set from two thousand years ago.'] },
      { h: ['二十四节气：太阳的刻度', 'The 24 solar terms: the sun\'s ruler'],
        body: ['把太阳一年走过的那一圈（黄道，共 360°）均分成二十四段，每段 15°，每跨一段便是一个节气。它们交替称「节」与「中气」：立春、惊蛰等十二为「节」，雨水、春分等十二为「中气」。因只随太阳，节气落在公历里的日期几乎固定，前后不过一两天。下表是完整的二十四节气与其太阳黄经：',
          'Divide the sun\'s yearly circle (the ecliptic, 360°) into twenty-four equal 15° arcs; each arc you cross is a solar term. They alternate between "nodes" (jie) — Lichun, Jingzhe… — and "mid-terms" (zhongqi) — Yushui, Chunfen… Because they follow the sun alone, their Gregorian dates barely move, within a day or two. The table below is the full set with each term\'s solar longitude:'],
        table: { head: [['节气', 'Term'], ['黄经', 'Longitude'], ['约公历', '~Date']], rows: [
          ['立春 Lìchūn', '315°', '~Feb 4'], ['雨水 Yǔshuǐ', '330°', '~Feb 19'], ['惊蛰 Jīngzhé', '345°', '~Mar 6'],
          ['春分 Chūnfēn', '0°', '~Mar 20'], ['清明 Qīngmíng', '15°', '~Apr 5'], ['谷雨 Gǔyǔ', '30°', '~Apr 20'],
          ['立夏 Lìxià', '45°', '~May 6'], ['小满 Xiǎomǎn', '60°', '~May 21'], ['芒种 Mángzhòng', '75°', '~Jun 6'],
          ['夏至 Xiàzhì', '90°', '~Jun 21'], ['小暑 Xiǎoshǔ', '105°', '~Jul 7'], ['大暑 Dàshǔ', '120°', '~Jul 23'],
          ['立秋 Lìqiū', '135°', '~Aug 8'], ['处暑 Chǔshǔ', '150°', '~Aug 23'], ['白露 Báilù', '165°', '~Sep 8'],
          ['秋分 Qiūfēn', '180°', '~Sep 23'], ['寒露 Hánlù', '195°', '~Oct 8'], ['霜降 Shuāngjiàng', '210°', '~Oct 24'],
          ['立冬 Lìdōng', '225°', '~Nov 7'], ['小雪 Xiǎoxuě', '240°', '~Nov 22'], ['大雪 Dàxuě', '255°', '~Dec 7'],
          ['冬至 Dōngzhì', '270°', '~Dec 22'], ['小寒 Xiǎohán', '285°', '~Jan 6'], ['大寒 Dàhán', '300°', '~Jan 20'],
        ], caption: ['「节」定月之始，「中气」定月之名；本应用按真太阳黄经（定气）推算至分钟。', 'Nodes start a month, mid-terms name it; this app computes them from true solar longitude, to the minute.'] } },
      { h: ['节气里的烟火', 'Daily life in the terms'], figure: 'sky_season',
        body: ['节气从不只是天文——它是一部生活的日历。农谚把农时压成顺口的句子：「清明前后，种瓜点豆」「白露早、寒露迟，秋分种麦正当时」。饮食也随之轮转：立春「咬春」吃春饼，冬至北方吃饺子、南方搓汤圆，清明青团碧绿。\n\n2016 年，「二十四节气」被联合国教科文组织列入人类非物质文化遗产。它提醒我们：择日之学最底层的，并非玄虚，而是这套对太阳的精确观测。',
          'The terms were never mere astronomy — they are a calendar for living. Farm sayings compress the year\'s work into easy lines: "around Qingming, plant the melons and beans"; "Bailu too early, Hanlu too late — Qiufen is the time to sow wheat." Food turns with them too: "biting spring" pancakes at Lichun, dumplings in the north and glutinous tangyuan in the south at the winter solstice, jade-green qingtuan at Qingming.\n\nIn 2016 UNESCO inscribed the 24 solar terms on its list of humanity\'s intangible cultural heritage. The reminder underneath: the bedrock of date-selection is not mysticism but this precise observation of the sun.'] },
    ],
    takeaways: [
      ['冬至影最长、夏至影最短——一根圭表就能钉住四季。', 'Longest shadow at the winter solstice, shortest at the summer — one gnomon pins the seasons.'],
      ['二十四节气把黄道 360° 均分为二十四段，每段 15°。', 'The 24 terms divide the ecliptic\'s 360° into twenty-four 15° arcs.'],
      ['节气只随太阳，故公历日期几乎固定（前后一两天）。', 'Tracking the sun alone, the terms barely move in the Gregorian calendar.'],
      ['节气是历法的骨架，也是农时与饮食的指南，2016 年入选世界非遗。', 'The terms are the calendar\'s skeleton and a guide to farming and food — UNESCO-listed in 2016.'],
    ],
    glossaryLinks: ['jieqi', 'zhongqi', 'shuo', 'runyue'],
  },
  {
    id: 'bargain', figure: 'bargain', readMin: 4,
    ...
    sections: [
      { h: ['两种历法，一个难题', 'Two calendars, one problem'], figure: 'bargain_moon',
        body: ['太阳给了我们四季：地球绕日一周约 365.24 天，是为「回归年」。月亮给了我们月份：从一个朔（看不见月亮）到下一个朔约 29.53 天，是为「朔望月」。麻烦在于——十二个朔望月只有约 354 天，比一个太阳年整整短了十一天。\n\n世界上的历法各有取舍：纯阴历（如伊斯兰历）只认月亮，节日便在四季里慢慢漂移；纯阳历（如公历）只认太阳，「月」与月相再无关系。中国走了第三条路——「阴阳合历」：月份跟着月亮，年份跟着太阳，用一个巧妙的办法把两者调和。',
          'The sun gives us seasons: Earth circles it in about 365.24 days — the tropical year. The moon gives us months: from one new moon (when no moon shows) to the next is about 29.53 days — the synodic month. The trouble: twelve synodic months come to only ~354 days, a full eleven days short of a solar year.\n\nThe world\'s calendars each pick a side. A pure lunar calendar (like the Islamic one) follows the moon, so its festivals drift slowly through the seasons. A pure solar calendar (like the Gregorian) follows the sun, so its "months" no longer track the moon at all. China took a third road — the lunisolar calendar: months follow the moon, years follow the sun, and a neat device reconciles the two.'] },
      { h: ['闰月：十九年七闰', 'The leap month: seven in nineteen years'],
        body: ['调和之法，就是隔几年补上一个「闰月」。古希腊人也独立发现了同一个节拍：19 个太阳年几乎正好等于 235 个朔望月——多出的 7 个月，便是十九年里要补的七个闰月（西方称「默冬章」，中国称「章法」）。\n\n中国置闰的规则更见巧思，靠的是「中气」：每个朔望月本应含一个中气，但因月稍短，偶尔有某月「轮空」——这个没有中气的月份便定为闰月，沿用上一个月的名字（如「闰四月」）。下表是这套机制的要点：',
          'The fix is to add a "leap month" every few years. The ancient Greeks independently found the same beat: 19 solar years almost exactly equal 235 synodic months — the 7 extra months are the seven leap months across nineteen years (the West calls it the Metonic cycle; China, the zhang rule).\n\nChina\'s rule for placing them is the more elegant, hinging on the mid-terms (zhongqi): each lunar month should contain one mid-term, but because the month runs slightly short, now and then a month catches none — that mid-term-less month becomes the leap month, reusing the previous month\'s name (e.g. "leap fourth month"). The table below sums up the mechanism:'],
        table: { head: [['概念', 'Concept'], ['作用', 'Role']], rows: [
          ['朔望月 ~29.53d', ['一朔到次朔，定「月」之长', 'New moon to new moon — sets a month\'s length']],
          ['回归年 ~365.24d', ['太阳走一圈，定「年」之长', 'One solar circuit — sets a year\'s length']],
          ['十一天之差', ['12 月比 1 年短约 11 天，须补', '12 months fall ~11 days short — must be made up']],
          ['十九年七闰', ['19 年≈235 月，补 7 个闰月', '19 years ≈ 235 months — add 7 leap months']],
          ['无中气置闰', ['首个无中气之月即闰月', 'The first mid-term-less month becomes the leap month']],
        ], caption: ['本应用以「定朔」「定气」推算，闰月判定与官方历书一致。', 'This app uses true new-moons and true solar terms; its leap-month logic matches the official almanac.'] } },
      { h: ['为什么春节会「跑来跑去」', 'Why Spring Festival moves around'], figure: 'bargain_festival',
        body: ['正因为是阴阳合历，农历的节日在公历里看起来「不固定」：春节（正月初一）可早至 1 月 21 日，晚至 2 月 20 日，前后相差近一个月——遇上闰月之年尤其明显。但换个角度，它们其实非常「固定」：中秋永远是满月，端午永远在初夏的午月，每个传统节日都牢牢系在月相或节气上。\n\n这正是择日之学的根基：先有一套能同时照顾太阳与月亮的精确历法，才谈得上哪天宜、哪天忌。',
          'Because it is lunisolar, the calendar\'s festivals look "unfixed" against the Gregorian one: Spring Festival (the first day of the first lunar month) can fall as early as 21 January or as late as 20 February — nearly a month\'s spread, most visible in leap-month years. Yet from another angle they are perfectly fixed: the Mid-Autumn Festival is always a full moon, the Dragon-Boat Festival always in the early-summer wu month — every traditional festival is anchored to a moon phase or a solar term.\n\nThis is the foundation of date-selection: only once you have a precise calendar honouring both sun and moon can you speak of which day suits and which to avoid.'] },
    ],
    takeaways: [
      ['朔望月约 29.53 天，回归年约 365.24 天，十二个月差约十一天。', 'A synodic month ~29.53 days, a tropical year ~365.24 — twelve months fall ~11 days short.'],
      ['中国用「阴阳合历」：月随月亮、年随太阳，以闰月调和。', 'China\'s lunisolar calendar: months by the moon, years by the sun, reconciled by leap months.'],
      ['十九年置七闰；无中气之月即为闰月。', 'Seven leap months in nineteen years; a month with no mid-term becomes the leap month.'],
      ['节日看似漂移，实则牢牢系在月相与节气上。', 'Festivals seem to drift but are firmly tied to moon phases and solar terms.'],
    ],
    glossaryLinks: ['runyue', 'nongli', 'zhongqi', 'shuo'],
  },
  {
    id: 'wheel', figure: 'wheel', readMin: 5,
    ...
    sections: [
      { h: ['干与支：十与十二', 'Stems and branches: ten and twelve'], figure: 'wheel_tokens',
        body: ['古人纪日，用两套符号：十个「天干」——甲乙丙丁戊己庚辛壬癸，与十二个「地支」——子丑寅卯辰巳午未申酉戌亥。天干各属五行之阴阳（甲为阳木、乙为阴木……）；地支则配上十二生肖、十二方位与十二时辰。\n\n把天干与地支像两个齿轮一样咬合转动：甲配子成「甲子」，乙配丑成「乙丑」……每转一格，干支各进一位。下表是十天干与其五行阴阳：',
          'The ancients counted days with two sets of symbols: ten "heavenly stems" — jia, yi, bing, ding, wu, ji, geng, xin, ren, gui — and twelve "earthly branches" — zi, chou, yin, mao, chen, si, wu, wei, shen, you, xu, hai. Each stem carries an element and a polarity (jia = yang wood, yi = yin wood…); each branch maps to a zodiac animal, a direction and a double-hour.\n\nMesh the two like gears: jia with zi makes "jiazi", yi with chou makes "yichou"… each click advances both by one. The table below gives the ten stems with their element and polarity:'],
        table: { head: [['天干', 'Stem'], ['五行', 'Element'], ['阴阳', 'Polarity']], rows: [
          ['甲 jiǎ', ['木', 'Wood'], ['阳', 'Yang']], ['乙 yǐ', ['木', 'Wood'], ['阴', 'Yin']],
          ['丙 bǐng', ['火', 'Fire'], ['阳', 'Yang']], ['丁 dīng', ['火', 'Fire'], ['阴', 'Yin']],
          ['戊 wù', ['土', 'Earth'], ['阳', 'Yang']], ['己 jǐ', ['土', 'Earth'], ['阴', 'Yin']],
          ['庚 gēng', ['金', 'Metal'], ['阳', 'Yang']], ['辛 xīn', ['金', 'Metal'], ['阴', 'Yin']],
          ['壬 rén', ['水', 'Water'], ['阳', 'Yang']], ['癸 guǐ', ['水', 'Water'], ['阴', 'Yin']],
        ], caption: ['五行各分阴阳，正好十干；地支亦各藏干，是干支推演之本。', 'Five elements split into yin and yang make exactly ten stems; branches hide stems too — the basis of ganzhi reckoning.'] } },
      { h: ['六十甲子：为什么是六十', 'The sixty: why exactly sixty'],
        body: ['十与十二咬合，多久回到起点？答案不是 120，而是 60——十与十二的最小公倍数。原因在于干支配对永远「阳配阳、阴配阴」：甲（阳）只能配子寅辰…（阳支），故可能的组合只有 60 个，从甲子起、到癸亥止，称「六十甲子」，俗称「一甲子」。\n\n这套六十循环不只纪日，也纪年、纪月、纪时。更妙的是「纳音」：把六十甲子两两并作一象，得「海中金」「炉中火」「大林木」等三十个富诗意的名字，旧通书常注在日柱之下。',
          'Mesh ten with twelve — how long until it returns to the start? The answer is not 120 but 60, the least common multiple of ten and twelve. The reason: ganzhi pairs are always "yang with yang, yin with yin" — jia (yang) can only meet zi, yin, chen… (yang branches), so only 60 combinations exist, from jiazi to guihai — the "sixty jiazi", colloquially "one jiazi".\n\nThis sixty-cycle counts not just days but years, months and hours. Lovelier still is nayin: pair the sixty into thirty poetic "melodic elements" — "Gold in the Sea", "Fire in the Furnace", "Wood of the Great Forest" — which old almanacs print beneath the day pillar.'] },
      { h: ['两千年未断的日子', 'The day-count unbroken for two thousand years'], figure: 'wheel_record',
        body: ['干支纪日最了不起之处，是它的「连续」。早在商代的甲骨文里，占卜的日子就已用干支记录；此后两千多年，纪日干支一天不落、从未间断——这在世界历法史上极为罕见。\n\n正因如此，任何一天的「日柱」都能从儒略日数精确反推、彼此核验，不靠任何信仰。文化上，六十年走完一轮叫「花甲」，故六十岁寿辰称「六十大寿」，取「一甲子圆满」之意。本应用的一切推算，正建立在这条从不说谎的连续链上。',
          'The marvel of the ganzhi day-count is its continuity. Already in the oracle-bone inscriptions of the Shang dynasty, divination days were recorded in stems and branches; and for the two-thousand-odd years since, the day count has run without missing a single day — a rarity in the history of world calendars.\n\nBecause of this, any day\'s pillar can be derived exactly from the Julian Day Number and cross-checked, with no appeal to belief. Culturally, completing one sixty-year round is "huajia", so a sixtieth birthday is a "great sixtieth" — "one jiazi made whole". Every computation in this app rests on that never-lying continuous chain.'] },
    ],
    takeaways: [
      ['十天干配十二地支，阳配阳、阴配阴，共得六十组。', 'Ten stems pair with twelve branches, yang with yang and yin with yin — sixty combinations in all.'],
      ['六十是十与十二的最小公倍数，故循环为「六十甲子」。', 'Sixty is the least common multiple of ten and twelve — hence the sixty-jiazi cycle.'],
      ['干支纪日自商代甲骨文起两千余年从未间断。', 'The ganzhi day-count has run unbroken since Shang oracle bones — over two thousand years.'],
      ['正因连续，日柱可由儒略日精确反推、核验——这是本应用的根基。', 'Because it is continuous, any day pillar derives from the Julian Day Number and verifies — the app\'s foundation.'],
    ],
    glossaryLinks: ['ganzhi', 'tiangan', 'dizhi', 'shengxiao', 'nayin'],
  },
  {
  ...
  {
    id: 'openshop', figure: 'openshop', readMin: 7,
    title: ['择日实战：开新店', 'Worked example: opening a shop'],
    story: ['开一家新店，老一辈总要「挑个好日子」。这一课把前面学的节气、干支、建除、黄道、神煞、生肖与时辰，全部串成一套可操作的流程：从定范围、读高分日，到避冲、挑吉时。我们也用两个虚构却贴近真实的案例走一遍，并始终提醒：这是依传统规则的推算参考，而非保证。',
      'Opening a new shop, the older generation always "picks a good day." This lesson threads everything so far — solar terms, ganzhi, the day-officers, the bright and dark paths, the spirits, your zodiac and the double-hours — into one practical workflow: set a window, read the high-scoring days, dodge the clash, and pick the hour. We walk it through two illustrative cases, and keep reminding ourselves: this is guidance by tradition, not a guarantee.'],
    sections: [
      { h: ['开市择日的渊源', 'The roots of choosing an opening day'], figure: 'openshop_almanac',
        body: ['「择吉开市」并非现代发明。早在汉代《淮南子·天文训》，「建除」十二神便已用来标记每日宜忌；到清乾隆四年（1739），朝廷敕修《協紀辨方書》，把历代择日之法系统化、辨正，成为后世通书的总纲。民间的「通书」与「黄历」即由此而来，世代相传。\n\n文化上，开张之日讲究热闹与彩头：贴红联、挂灯笼、剪彩、放鞭炮、迎「财神」，皆取「开门红」之意。择一吉日，既是对天时的敬重，也是给街坊、伙计与自己一个郑重的开始。本应用承此传统，却只呈现可核对的依据，从不替你下结论。',
          'Choosing an auspicious opening day is no modern invention. As early as the Han-dynasty Huainanzi (2nd c. BCE), the twelve "jianchu" officers already marked each day\'s suits and taboos; and in 1739 the Qing court commissioned the Xieji Bianfang Shu, which systematised and corrected centuries of date-selection lore into the master template for every later almanac. The folk 通书 and 黄历 descend from it, handed down for generations.\n\nCulturally, an opening day is meant to be loud and lucky: red couplets, hung lanterns, a cut ribbon, firecrackers, a welcome to the God of Wealth — all the spirit of 开门红, "open to good fortune." Choosing a good day honours the timing and gives your neighbours, staff and yourself a deliberate beginning. This app inherits the tradition but shows only the checkable basis — it never decides for you.'] },
      { h: ['一天如何挣得吉凶：十二建除', 'How a day earns its verdict: the twelve officers'], figure: 'openshop_read',
        body: ['每一天都由一位「值日官」当班——十二建除神依节气与月支轮转：建、除、满、平、定、执、破、危、成、收、开、闭。它们各有性格，也各有所宜。下表是传统上与「开市」的对应（各家通书略有出入，本应用以高、中置信者为准）：',
          'Every day is run by an officer on duty — the twelve jianchu rotate by solar term and month-branch: Establish, Remove, Full, Level, Stable, Hold, Break, Danger, Complete, Gather, Open, Close. Each has a character and its own suits. The table below is the traditional reading for "opening business" (almanacs differ a little; this app follows the high- and medium-confidence consensus):'],
        table: { head: [['建除', 'Officer'], ['含义', 'Nature'], ['开市', 'For an opening']], rows: [
          ['建 jiàn', ['建始', 'establish'], ['平', 'neutral']],
          ['除 chú', ['除旧', 'clear out'], ['宜', 'good — clear & renew']],
          ['满 mǎn', ['圆满', 'fullness'], ['宜', 'good — wealth']],
          ['平 píng', ['平稳', 'level'], ['平', 'neutral']],
          ['定 dìng', ['安定', 'settled'], ['宜', 'good']],
          ['执 zhí', ['执守', 'hold'], ['平', 'neutral']],
          ['破 pò', ['破败', 'break'], ['忌', 'avoid — major']],
          ['危 wēi', ['危险', 'danger'], ['忌', 'avoid']],
          ['成 chéng', ['成就', 'complete'], ['大吉', 'best']],
          ['收 shōu', ['收获', 'gather'], ['宜', 'good — take wealth']],
          ['开 kāi', ['开张', 'open'], ['大吉', 'best']],
          ['闭 bì', ['闭塞', 'close'], ['忌', 'avoid']],
        ], caption: ['开、成最吉；定、满、收次之；破为大忌，危、闭亦避。', 'Open & Complete are best; Stable / Full / Gather follow; Break is a major taboo, Danger & Close are avoided.'] } },
      { h: ['四步择吉：实战流程', 'The workflow: four steps'],
        body: ['把规则化为操作，四步即可：\n\n一、定事项与范围。在「黄历／择日」选「开市」；若同时签约、进货，加选「立券」「交易」。范围给一到两个月，候选越多越好。\n\n二、读高分日。点开高分日，对照四项：建除（见上表）、黄道或黑道、二十八宿、神煞——四项俱佳，方为上选。\n\n三、避冲。看当日「冲」哪个生肖、煞在何方；若冲店主本命，宁可另择。\n\n四、挑吉时。选定吉日后，再挑当日一个黄道而不冲的时辰开门。\n\n技术细节：建除并非随机，而是「正月起寅、逐日顺布、遇节气则重一日」——故相邻两天可能官星相同。你不必手算，应用已为你算好；但明白原理，便不易被「玄学」唬住。',
          'Turn the rules into action in four steps:\n\n1. Set activity & window. In Calendar / Find pick 开市; if you will also sign or stock up, add 立券 and 交易. Give a one-to-two-month window — the more candidates the better.\n\n2. Read the top days. Open a high scorer and check four things: the officer (table above), bright vs dark path, the lunar mansion, and the spirits — best is when all four align.\n\n3. Dodge the clash. See which zodiac the day "clashes" and the ill direction; if it clashes the owner\'s own sign, prefer another day.\n\n4. Pick the hour. With the day chosen, take a bright, non-clashing double-hour to open.\n\nA technical note: the officer is not random — it runs "begin at 寅 in the first month, advance one per day, and repeat a day at each solar term," so two adjacent days can share one. You needn\'t compute it by hand — the app does — but knowing the mechanism keeps the mystique from fooling you.'] },
      { h: ['冲煞与生肖：六冲', 'Clash and your zodiac: the six oppositions'], figure: 'openshop_clash',
        body: ['「冲」源于地支「六冲」：子午、丑未、寅申、卯酉、辰戌、巳亥——两两相隔六位、方位相对、五行相克。通书每日的地支，会「冲」其对位的生肖；当事人若属那一生肖，传统上当避大事。\n\n例如：当日为「子」日，则冲「午」，属马者宜避，煞方亦随之而定。开店的主事者，最该留意自己的本命年支是否被冲。\n\n文化上，这是一份体贴：它提醒主家「今日与你相左」，宁缓一日，求个心安。它从不是命运的判决——本应用如实标出所冲生肖与煞方，权衡仍在你手。',
          'A "clash" comes from the six oppositions of the earthly branches — zi-wu, chou-wei, yin-shen, mao-you, chen-xu, si-hai — each pair six apart, opposite in direction and mutually overcoming in element. The day\'s branch "clashes" the sign across from it; a person of that sign should, by tradition, avoid major undertakings.\n\nFor example, on a 子 (Rat) day the clash is 午 (Horse): those born in the Horse year should hold back, and the ill direction follows. The person opening the shop should most watch whether their own birth-year branch is clashed.\n\nCulturally this is a kindness: it warns the host that "today runs against you," so wait a day for peace of mind. It is never fate\'s verdict — the app marks the clashed sign and ill direction plainly, and the weighing stays with you.'] },
      { h: ['良辰：十二时辰', 'The auspicious hour: the twelve double-hours'], figure: 'openshop_hour',
        body: ['古人将一日均分为十二时辰，每辰两小时，以地支为名。择定吉日后，再于日内择一良辰开门，是为「精挑」。时辰之吉凶与日同理：分黄道黑道，亦各有所冲。',
          'The ancients split a day into twelve double-hours of two hours each, named by the earthly branches. After fixing the day, choosing a fine hour within it to open the doors is the fine-tuning step. An hour\'s fortune works like a day\'s: bright or dark path, each with its own clash.'],
        table: { head: [['时辰', 'Double-hour'], ['时间', 'Clock'], ['生肖', 'Sign']], rows: [
          ['子 zǐ', '23:00–01:00', ['鼠', 'Rat']],
          ['丑 chǒu', '01:00–03:00', ['牛', 'Ox']],
          ['寅 yín', '03:00–05:00', ['虎', 'Tiger']],
          ['卯 mǎo', '05:00–07:00', ['兔', 'Rabbit']],
          ['辰 chén', '07:00–09:00', ['龙', 'Dragon']],
          ['巳 sì', '09:00–11:00', ['蛇', 'Snake']],
          ['午 wǔ', '11:00–13:00', ['马', 'Horse']],
          ['未 wèi', '13:00–15:00', ['羊', 'Goat']],
          ['申 shēn', '15:00–17:00', ['猴', 'Monkey']],
          ['酉 yǒu', '17:00–19:00', ['鸡', 'Rooster']],
          ['戌 xū', '19:00–21:00', ['狗', 'Dog']],
          ['亥 hài', '21:00–23:00', ['猪', 'Pig']],
        ], caption: ['计时之器，从汉之「漏刻」到后世盘香「香篆」，由来已久；开张多取上午黄道吉时。', 'Timekeeping ran from the Han clepsydra to the later coiled-incense "seal"; openings usually take a bright morning hour.'] } },
    ],
    cases: [
      { t: ['案例一：陈先生的茶馆', 'Case 1 — Mr Chen\'s teahouse'], figure: 'openshop_tea',
        body: ['陈先生属兔，想在十月开一家茶馆。他在应用里选「开市＋交易」，范围设为十月一日到十一月十五日。排序后，10 月 18 日得分很高：值「成」日、黄道、当日吉神有「天德」。\n\n但他一看——那天「冲兔」，正冲自己本命。于是他往下找：10 月 22 日，值「开」日、黄道、不冲兔，分数略低却更安心。他选了 22 日，再挑当日辰时（7–9 时，黄道且不冲）剪彩。整个过程不到五分钟，而且每一步他都看得见依据。',
          'Mr Chen, born in the year of the Rabbit, wants to open a teahouse in October. In the app he picks 开市 + 交易 and sets the window from 1 Oct to 15 Nov. After ranking, 18 October scores high: a "Complete" (成) day, bright-path, with the benefic Tiande present.\n\nBut he notices it "clashes Rabbit" — his own sign. So he reads down: 22 October, an "Open" (开) day, bright-path, not clashing Rabbit — slightly lower, but easier on the mind. He takes the 22nd, then picks the chen double-hour (07:00–09:00, bright and non-clashing) for the ribbon. The whole thing took under five minutes, and he could see the basis for every step.'] },
      { t: ['案例二：窗口很窄时怎么办', 'Case 2 — when the window is tight'],
        body: ['林女士的铺面租约从下月一日起算，只有头一周能开张。她一查，那七天里没有「开、成、定」的黄道吉日，最好的一天还冲她的生肖。这时怎么办？\n\n传统的务实态度是「两害相权取其轻」：先避开最凶的「破」「危」日，再从平日里挑一个不冲自己、且有吉时可用的日子；最后把仪式放在当天的黄道吉时，以时辰之吉补日子之平。\n\n应用的诚实正在此——它不会把一个平日粉饰成大吉，而是如实让你看清，在受限的现实里做出权衡。择日是助人安心的传统，不是制造焦虑的枷锁。',
          'Ms Lin\'s lease starts on the 1st of next month, and only the first week works for opening. She checks: none of those seven days is a bright-path "Open/Complete/Stable" day, and the best of them clashes her sign. What then?\n\nThe pragmatic tradition is "of two harms, take the lighter": first avoid the worst "Break/Danger" days; then choose, from the ordinary days, one that does not clash you and has a usable lucky hour; finally hold the ceremony in that day\'s bright double-hour, letting a good hour make up for an average day.\n\nThis is exactly where the app\'s honesty helps: it will not dress an ordinary day up as highly auspicious, but shows you plainly so you can weigh trade-offs within real constraints. Date-selection is a tradition to set the mind at ease, not a shackle to manufacture anxiety.'] },
    ],
    takeaways: [
      ['先定范围（一到两个月）——候选越多，越挑得到好日子。', 'Set a window first (1–2 months) — more candidates, better choices.'],
      ['读高分日要看「建除＋黄道＋宿＋神煞」四条，而非只看分数。', 'Read a top day by officer + path + mansion + spirits, not the score alone.'],
      ['店主本命被「冲」的开张日，传统上宁可避开。', 'A day that clashes the owner\'s own zodiac is, by tradition, best avoided.'],
      ['吉日难寻时，用当天的黄道吉时来补救。', 'When good days are scarce, a bright double-hour is the fall-back remedy.'],
      ['建除可溯至《淮南子》，择日法集大成于《協紀辨方書》(1739)——传统有据，但仍非定论。', 'The officers trace to the Huainanzi; the method was codified in the Xieji Bianfang Shu (1739) — well-grounded tradition, but still not a verdict.'],
    ],
    glossaryLinks: ['jianchu', 'huangdao', 'shengxiao', 'ss', 'verdict'],
  },
];
